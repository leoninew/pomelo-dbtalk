...
| [`dbtalk-postgres`](../plugins/dbtalk/skills/postgres/SKILL.md) | PostgreSQL 单库逻辑备份、恢复 custom archive 或配置 Docker client image。 | `dbtalk postgres` | [PostgreSQL 手册](postgres.md) |
